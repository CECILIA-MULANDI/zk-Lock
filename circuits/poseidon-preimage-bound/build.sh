...
# Reproducible build for the zk-Lock bound-variant Poseidon preimage circuit.
# Reuses the ptau committed under ../poseidon-preimage/ptau/ to avoid
# duplicating the 4.6M binary.
BUILD_DIR="build"
PTAU_FILE="../poseidon-preimage/ptau/powersOfTau28_hez_final_12.ptau"
